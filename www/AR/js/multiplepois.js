...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		World.updateStatuMsessage(currentPlaceNr + ' places loaded');
	},
	...
	requestDataFromLocal: function requestDataFromLocalFn(centerPointLatitude, centerPointLongitude) {
		...
		for (var i = 0; i < cantidad_lugares; i++) {
			...
			poiData.push({
				"id":  World.array_lugares[i].id,
				"longitude":  World.array_lugares[i].lon,
				"latitude":  World.array_lugares[i].lat,
				"item":  World.array_lugares[i],
				"altitude": "100.0",
				"name":  World.array_lugares[i].name,
				"title": 'pepe',
				"description": 'caca'
			});
